...
class _NewExpnse extends State<NewExpense> {
  ...
  void _submitExpense() {
    ...
    //widget provides access all the current class properties
    widget.onAddExpense(ExpenseData(title: _titleController.text, amount: enteredAmount, date: _selectedDate!, category: _selectedCategory));
    Navigator.pop(context);
  }
}
